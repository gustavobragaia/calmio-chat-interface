    ...
    <div className="min-h-screen bg-background pb-8 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-8 space-y-10 max-w-md mx-auto w-full">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className={`w-56 h-56 rounded-full border-8 flex items-center justify-center shadow-sm bg-white z-10 transition-colors duration-500 ${isActive ? 'border-[#FACC15]' : 'border-gray-200'}`}>
